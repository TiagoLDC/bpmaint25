		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bpmaint25bpmaint25-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpmaint25bpmaint25-display": {
								"semanticObject": "bpmaint25bpmaint25",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpmaint25.bpmaint25",
									"url": sap.ui.require.toUrl("bpmaint25/bpmaint25")
								}
							}
						}
					}
